...
public class MerchantController {
    ...
    public ResponseEntity certifyMerchant(@PathVariable int adminId, @PathVariable int merchantId) {
        ...
        switch (flag) {
            ...
            default:
                return ResponseEntity.status(400).body(new ApiResponse("Certify merchant successfully"));
        }
